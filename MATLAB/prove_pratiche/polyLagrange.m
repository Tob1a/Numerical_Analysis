...
% Calcola i coefficienti dei polinomi di Lagrange per il polinomio
% interpolante i valori ’y’ nei punti ’x ’. Restituisce in ’p’ il
% valore del polinomio nei punti ’punti ’.
% SYNOPSIS
...
end % fine della function polyLagrange